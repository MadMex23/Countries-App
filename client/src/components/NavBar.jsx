    ...
    return (
        <div className="nav">
           ...
           <select className= "selection" defaultValue='' onChange={e => handlerOrder(e)}>
               ...
               <option className='option' value='ZtoA'>Z to A</option>
               <option className='option' value='PopHigh'>High Population</option>
               <option className='option' value='PopLow'>Low Population</option>
           </select>
           <select className= "selection" defaultValue='' onChange={e => handlerContinent(e)}>
               <option className='option' value='' >Choose Continent</option>
               ...
               <option className='option' value='Antarctica'>Antartica</option>
           </select>
           <select className= "selection" defaultValue='' onChange={e => handlerActivity(e)}>
                <option className='option' value=''>Choose Activity</option>
                {selector?.map(e => {
                    return (
                        <option className='option' key={e.id} value={e.name}>{e.name}</option>
                    )
                })
                }
           </select>
